...
import { first } from '../../../assets/images/images'
    ...
    return (
        <View style={styles.mainView}>
            ...
            <View>
                ...
                <View style={styles.dropDownView}>
                    ...
                    <SelectList
                        ...
                        data={data}
                        arrowicon={<Feather name="chevron-down" size={15} color={'black'} />}
            ...
            <View>
                ...
                <Footer powered={{color:'black'}} ensemble={{color:'black'}} iconName={'chevron-right'} onPress={() => navigation.navigate('jobtitle')} />
            </View>
        ...
        <View style={styles.bottomsheet}>
          ...
          <Text style={styles.textBoard}>Ten super fun questions that will tell us more about you ✌️</Text>
        
          <Button title={'Begin'} buttonStyle={styles.button} onPress={() => refRBSheet.current.close()} />
        </View>
