    ...
    return (
        <View style={styles.mainView}>
           ...
           {show? <View style={styles.input}>
                ...
                <TextInput placeholderTextColor='#414141' value={props.value ? props.value : null} onChangeText={props.onChangeText ? (e) => props.onChangeText(e) : null} style={[styles.input, props.inputStyle]} placeholder='Write other option here..' multiline={true} />
