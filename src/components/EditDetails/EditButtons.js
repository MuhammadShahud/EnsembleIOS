                ...
                <View
                    ...
                    {props.properties.map(v => (
                        <View style={styles.button}>
                            ...
                            {props.cross ?
                                <TouchableOpacity style={styles.crossStyle}>
                    ...
                    {props.addIcon ?
                        ...
                        <TouchableOpacity onPress={inputBox} style={{ justifyContent: 'center' }}>
                ...
                {show ? props.input ? (
                    <View style={styles.input}>
                        <TextInput
                            ...
                            multiline={true}
                        />
                        <TouchableOpacity style={styles.circleView} onPress={inputPlusIcon}>
